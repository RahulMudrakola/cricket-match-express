...
const covertDbObjectToResponseObject = (eachPlayer) => {
  return {
...
app.get("/players/", async (request, response) => {
  ...
  response.send(
    playersArray.map((eachPlayer) => covertDbObjectToResponseObject(eachPlayer))
  );
});
...
app.get("/players/:playerId", async (request, response) => {
  ...
  response.send(covertDbObjectToResponseObject(playerArray));
});
